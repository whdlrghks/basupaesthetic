...
// age >= 35인 경우 목표 비율: 4.5 : 5.5, 즉 oilper 4.5 (오차 0.4 허용)
  ...
  String generateSkinResult({
    ...
    if (oilper >= 55) {
      ...
      switch (ratioResult) {
        case 6: //권장
          return "권장하는 유수분 비율은 수분 5.5 : 유분 4.5 입니다. 현재 유수분 밸런스가 좋습니다. ( 수분 "
              "${waterStr} : 유분 ${oilStr} ) ";
        case 5: // 유분 적음
          return "권장하는 유수분 비율은 수분 5.5 : 유분 4.5 입니다. 현재 유수분 밸런스가 안좋습니다. ( 수분 "
        ...
        case 3:
          return "권장하는 유수분 비율은 수분 6 : 유분 4 입니다. 현재 유수분 밸런스가 좋습니다. ( 수분 "
              "${waterStr} : 유분 ${oilStr} )";
        case 2:
          return "권장하는 유수분 비율은 수분 6 : 유분 4 입니다. 현재 유수분 밸런스가 안좋습니다. ( 수분 "
              "${waterStr} : 유분 ${oilStr} ) 유수분 밸런스 조절에 신경쓰세요. 유분보유력 "
              "증가를 위해 보습관련 코스를 추천합니다.\n${randomHighOilCare}";
        case 1:
          return "권장하는 유수분 비율은 수분 6 : 유분 4 입니다. 현재 유수분 밸런스가 안좋습니다. ( 수분 "
      ...
      switch (ratioResult) {
        ...
        case 2:
          return "권장하는 유수분 비율은 수분 6 : 유분 4 입니다. 현재 유수분 밸런스가 안좋습니다. ( 수분 "
              "${waterStr} : 유분 ${oilStr} )\n수분 대비 유분보유력이 약합니다. ${randomHighOilCare}";
        case 1:
          return "권장하는 유수분 비율은은 수분 6 : 유분 4 입니다. 현재 유수분 밸런스가 안좋습니다. ( 수분 "
              "${waterStr} : 유분 ${oilStr} )\n그것의 가장 큰 이유는 피부의 수분보유력이 약해서 그렇습니다. "
              "이 경우 유분감이 많다고 느껴질 수 있으나 이는 상대적으로 느끼는 것입니다. 유수분을 골고루 강화시켜줘야 하지만 수분위주의 관리가 필요합니다. "
              "${randomLowOilCare}";
        default:
