...
class _IndexState extends State<Index> {
  ...
  Future<void> _buttonPressed(int buttonNumber) async {
    ...
    switch (buttonNumber) {
      case 1:
        nextroute = resultcontroller.user_id.value != "" ? "/shortform" : "/s"
            "urvey";
        break;
      case 2:
        nextroute =  "/machine";
      ...
      case 3:
        ...
        Get.dialog(ShowQRdialog(modifiedUrl+nextroute, nextroute));
        return;
      case 4:
    ...
    return Scaffold( body: Center(
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            resultcontroller.user_id.value != "" ? '${resultcontroller.name
                .value}님을 환영합니다.' : "BASUP 피부 문진을 클릭해서\n새로운 고객을 등록해주세요",
            style: TextStyle(
          ...
          ElevatedButton(
            ...
            child: Text('BASUP 피부 문진', style: index_button,),
            style: ButtonStyle(
          ...
          ElevatedButton(
            ...
            child: Text('BASUP 피부 측정기 입력', style: index_button,),
            style: ButtonStyle(
              // Setting the background color
              backgroundColor: MaterialStateProperty.all(Color(0xFF49A85E)),
              // Setting the foreground color (text color)
          ...
          ElevatedButton(
            ...
            child: Text('BASUP 피부 현미경 입력', style: index_button,),
            style: ButtonStyle(
              // Setting the background color
              backgroundColor: MaterialStateProperty.all(Color(0xFF49A85E)),
              // Setting the foreground color (text color)
          ...
          ElevatedButton(
            ...
            child: Text('BASUP 피부 결과 확인', style: index_button,),
            style: ButtonStyle(
              // Setting the background color
              backgroundColor: MaterialStateProperty.all(Color(0xFF49A85E)),
              // Setting the foreground color (text color)
          ...
          ElevatedButton(
            ...
            child: Text('로그아웃', style: index_button,),
            style: ButtonStyle(
              // Setting the background color
              backgroundColor: MaterialStateProperty.all(Color(0xFF49A85E)),
              // Setting the foreground color (text color)
